...
import { Home, Building2, Users, Shield, ArrowRight, CheckCircle2, FileText, Handshake } from "lucide-react"
...
export default function LandingPage() {
  return (
    <div className="min-h-screen flex flex-col">
      <header className="border-b bg-white sticky top-0 z-50 shadow-sm">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-bold text-lg leading-tight text-[#0c4a6e]">Programa Entrada Garantida</h1>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-white/95 mb-8 text-pretty leading-relaxed max-w-2xl mx-auto drop-shadow-md">
              Política de Subsídio Habitacional para Famílias de Baixa Renda. Subsídio de até R$ 20 mil para entrada do
              imóvel.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" asChild className="text-base bg-[#22c55e] hover:bg-[#16a34a] text-white shadow-xl">
      ...
      <section className="py-16 bg-gradient-to-r from-[#0c4a6e] via-[#0e7490] to-[#0c4a6e] text-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              <div className="text-4xl font-bold text-[#fbbf24] mb-2">10.000</div>
              <div className="text-white/90">Famílias Contempladas</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-[#fbbf24] mb-2">R$ 20 mil</div>
              <div className="text-white/90">Valor do Subsídio</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-[#fbbf24] mb-2">R$ 250 mil</div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="relative h-[500px] rounded-2xl overflow-hidden shadow-2xl">
                <Image src="/familia-feliz.jpg" alt="Família feliz com casa própria" fill className="object-cover" />
              </div>
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-lg mb-2 text-[#0c4a6e]">Conceito</h4>
                      <p className="text-muted-foreground leading-relaxed">
                        Política pública estratégica para atender o <strong>déficit habitacional</strong> do Maranhão,
                        removendo a principal barreira financeira para a casa própria: a falta de recursos para a
                        entrada.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-lg mb-2 text-[#0c4a6e]">Público-Alvo</h4>
                      <p className="text-muted-foreground leading-relaxed">
                        Grupos familiares com <strong>renda mensal bruta de até 2 (dois) salários mínimos</strong>.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-lg mb-2 text-[#0c4a6e]">Cumulatividade</h4>
                      <p className="text-muted-foreground leading-relaxed">
                        O subsídio é <strong>cumulativo</strong> com outros benefícios, como o FGTS e subsídios federais
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              O programa é executado, coordenado e monitorado pela Secretaria de Estado de Monitoramento de Ações
              Governamentais (SEMAG)
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card className="border-2 border-[#0c4a6e] shadow-lg hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  ...
                  <h4 className="font-bold text-xl mb-3 text-center text-[#0c4a6e]">Preparação</h4>
              ...
              <Card className="border-2 border-[#db2777] shadow-lg hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  ...
                  <h4 className="font-bold text-xl mb-3 text-center text-[#db2777]">Habilitação</h4>
                  <p className="text-muted-foreground text-center leading-relaxed">
              ...
              <Card className="border-2 border-[#fbbf24] shadow-lg hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  ...
                  <h4 className="font-bold text-xl mb-3 text-center text-[#fbbf24]">Operacionalização</h4>
                  <p className="text-muted-foreground text-center leading-relaxed">
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h3 className="text-3xl md:text-4xl font-bold mb-4 text-[#0c4a6e]">Como Funciona o Programa</h3>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Um processo simples e transparente para você conquistar sua casa própria
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            <Card className="border-t-4 border-t-[#22c55e] shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="pt-6">
                ...
                <h4 className="font-bold text-lg mb-2 text-[#0c4a6e]">1. Cadastre-se</h4>
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Preencha seus dados e documentos necessários para participar do programa
                </p>
              </CardContent>
            </Card>
            <Card className="border-t-4 border-t-[#0c4a6e] shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="pt-6">
                ...
                <h4 className="font-bold text-lg mb-2 text-[#0c4a6e]">2. Escolha o Imóvel</h4>
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Navegue pelos imóveis disponíveis e escolha o que melhor atende sua família
                </p>
              </CardContent>
            </Card>
            <Card className="border-t-4 border-t-[#fbbf24] shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="pt-6">
                ...
                <h4 className="font-bold text-lg mb-2 text-[#0c4a6e]">3. Análise</h4>
                <p className="text-muted-foreground text-sm leading-relaxed">
            ...
            <Card className="border-t-4 border-t-[#db2777] shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="pt-6">
                ...
                <h4 className="font-bold text-lg mb-2 text-[#0c4a6e]">4. Aprovação</h4>
                <p className="text-muted-foreground text-sm leading-relaxed">
      ...
      <section className="py-20 bg-[#22c55e] text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <Image src="/conjunto-habitacional.jpg" alt="Conjunto habitacional" fill className="object-cover" />
        </div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <h3 className="text-3xl md:text-4xl font-bold mb-4">Você é Construtor ou Incorporador?</h3>
            <p className="text-lg mb-8 opacity-95 leading-relaxed">
              Cadastre seus empreendimentos e faça parte deste programa que vai transformar a vida de milhares de
      ...
      <footer className="border-t py-12 bg-[#0c4a6e] text-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              <h4 className="font-bold mb-4 text-[#fbbf24]">Programa Entrada Garantida</h4>
              <p className="text-sm text-white/80 leading-relaxed">
                Iniciativa do Governo do Estado do Maranhão para facilitar o acesso à moradia digna para famílias
                maranhenses de baixa renda.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <Link href="/beneficiario/cadastro" className="text-white/80 hover:text-white transition-colors">
                    Cadastro de Beneficiário
                  </Link>
                </li>
                <li>
                  <Link href="/construtor/cadastro" className="text-white/80 hover:text-white transition-colors">
                    Cadastro de Construtor
                  </Link>
                </li>
                <li>
                  <Link href="/imoveis" className="text-white/80 hover:text-white transition-colors">
                    Imóveis Disponíveis
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <p className="text-sm text-white/80 leading-relaxed">
                ...
                <br />
                Entre em contato com a SEMAG - Secretaria de Estado de Monitoramento de Ações Governamentais.
              </p>
            </div>
          </div>
          <div className="border-t border-white/20 pt-8 text-center text-sm text-white/70">
            <p>© 2025 Governo do Estado do Maranhão - SEMAG. Todos os direitos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
