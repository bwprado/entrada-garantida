            ...
            <CardContent>
              <form className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input id="email" type="text" placeholder="seu@email.com ou 000.000.000-00" required />
                </div>
                <div className="space-y-2">
              ...
              <div className="mt-6 pt-6 border-t space-y-3">
                <p className="text-sm text-center text-muted-foreground mb-4">Ainda não tem cadastro?</p>
