    ...
    (
      <div
        style={{
          ...
          background: 'linear-gradient(165deg, #e8f2fa 0%, #ffffff 55%, #f0f7fc 100%)',
        }}
      >
        {/* ~400px tall keeps the 550×602 PNG sharp (no upscaling). */}
        <img
          src={logoSrc}
          alt=""
          height={400}
...
export const ogImageAlt =
  'Aquisição Assistida — Programa estadual · Governo do Maranhão · SECID'
