...
// Enums
export const sexoEnum = z.enum(["feminino", "masculino", "nao-informado"])
...
// Beneficiary profile schema (stored in beneficiaryProfiles table)
export const beneficiarioProfileSchema = z.object({
  // Dados pessoais
  rg: z
  ...
  // Telefones adicionais (não o principal que é users.telefone)
  dddTelefoneFixo: z
    .string()
    .transform(onlyDigits)
...
export type BeneficiarioProfileFormData = z.infer<typeof beneficiarioProfileSchema>

// Combined schema for form convenience (merges user base + profile)
export const beneficiarioCompleteSchema = userBaseSchema.merge(beneficiarioProfileSchema)

export type BeneficiarioCompleteFormData = z.infer<typeof beneficiarioCompleteSchema>
